...
def main(args):
    ...
    tb_writer = SummaryWriter(log_dir="runs/voc_experiment")
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        tb_writer.add_scalar("mAP", coco_info[1], epoch)
...
if __name__ == "__main__":
    ...
    # 指定接着从哪个epoch数开始训练
    parser.add_argument('--start_epoch', default=12, type=int, help='start epoch')
    # 训练的总epoch数
    ...
    # 基于上次的训练结果接着训练
    parser.add_argument('--resume', default='multi_train/model_11.pth', help='resume from checkpoint')
